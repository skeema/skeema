...
func TestDockerImageForFlavor(t *testing.T) {
	testcases := []struct {
		...
		{"percona:8.0.41", "amd64", "percona/percona-server:8.0.41", false},
		{"percona:8.0.41", "arm64", "percona/percona-server:8.0.41", false},
		{"percona:8.1", "amd64", "percona/percona-server:8.1", false},
		{"percona:8.1", "arm64", "percona/percona-server:8.1.0-aarch64", false},
		{"percona:8.2.0", "amd64", "percona/percona-server:8.2.0", false},
		{"percona:8.2.0", "arm64", "percona/percona-server:8.2.0-aarch64", false},
		{"percona:8.4", "amd64", "percona/percona-server:8.4", false},
		{"percona:8.4", "arm64", "percona/percona-server:8.4", false},
		{"percona:8.4.0", "amd64", "percona/percona-server:8.4.0", false},
		{"percona:8.4.0", "arm64", "percona/percona-server:8.4.0-aarch64", false},
		{"percona:8.4.2", "amd64", "percona/percona-server:8.4.2", false},
		{"percona:8.4.2", "arm64", "percona/percona-server:8.4.2-aarch64", false},
		{"percona:8.4.4", "amd64", "percona/percona-server:8.4.4", false},
		{"percona:8.4.4", "arm64", "percona/percona-server:8.4.4", false},
		{"percona:9.7", "amd64", "percona/percona-server:9.7", false},
